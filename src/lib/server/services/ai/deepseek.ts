...
export class DeepSeekStrategy implements AIStrategy {
  ...
  async chat(messages: Message[]): Promise<string> {
    try {
      ...
      throw new AIServiceError('DeepSeek chat 请求失败', this.name, err)
    }
  }
  ...
  async evaluate(
    ...
    try {
      ...
      throw new AIServiceError('DeepSeek evaluate 请求失败', this.name, err)
    }
  ...
  async generateReport(
    ...
    try {
      ...
      throw new AIServiceError('DeepSeek generateReport 请求失败', this.name, err)
    }
  }
}
